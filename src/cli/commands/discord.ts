...
export function createDiscordCommand(): Command {
  ...
  discordCommand.on('--help', () => {
    console.log('');
    console.log('사용 예시:');
    console.log('  $ task-action send-message-discord "Hello, World!"');
    console.log('  $ task-action send-message-discord "배포 완료!"');
    console.log('  $ task-action send-message-discord "알림 메시지"');
    console.log('');
    console.log('환경 변수:');
...
export function showDiscordExamples(): void {
  ...
  console.log('  $ task-action send-message-discord "배포 완료!"');
  console.log('  $ task-action send-message-discord "알림 메시지"');
  console.log('  $ task-action send-message-discord "시스템 점검 완료"');
  console.log('');
  console.log('환경 변수 설정:');
  console.log('  $ export DISCORD_WEBHOOK_URL="https://discord.com/api/webhooks/..."');
  console.log('  $ task-action send-message-discord "환경변수로 전송"');
}
